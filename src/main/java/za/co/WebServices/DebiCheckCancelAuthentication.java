...
import org.datacontract.schemas._2004._07.nc_dg_tms_c_wcf.DebiCheckOptionsCancellationReasonCodes;
 ...
 *         <element name="reasonCode" type="{http://schemas.datacontract.org/2004/07/NC.DG.TMS.C.WCF.NIWS}DebiCheckOptions.CancellationReasonCodes" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlRootElement(name = "DebiCheckCancelAuthentication")
public class DebiCheckCancelAuthentication {
    ...
    protected DebiCheckOptionsCancellationReasonCodes reasonCode;
     ...
     * @return
     *     possible object is
     *     {@link DebiCheckOptionsCancellationReasonCodes }
     *     
     */
    public DebiCheckOptionsCancellationReasonCodes getReasonCode() {
        return reasonCode;
    }
     ...
     *     
     */
    public void setReasonCode(DebiCheckOptionsCancellationReasonCodes value) {
