...
@XmlRootElement(name = "RetrieveSpecificBatchStatus")
public class RetrieveSpecificBatchStatus {
    ...
    @XmlElementRef(name = "BatchName", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
