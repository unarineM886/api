...
@XmlRootElement(name = "AccountFundsTransfer")
public class AccountFundsTransfer {
    ...
    @XmlElementRef(name = "ToAccountNumber", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> toAccountNumber;
    @XmlElementRef(name = "BeneficiaryReference", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> beneficiaryReference;
     ...
     *     
     */
    public JAXBElement<String> getBeneficiaryReference() {
     ...
     *     
     */
    public void setBeneficiaryReference(JAXBElement<String> value) {
